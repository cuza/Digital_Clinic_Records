...
class Paciente
{
     ...
     * @var \Doctrine\Common\Collections\Collection
     *
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\Ingreso", mappedBy="paciente")
     */
    private $ingresos;
     ...
     * @return Paciente
     */
    public function addConsulta(\AppBundle\Entity\Consulta $consulta)
    {
     ...
     * @param \AppBundle\Entity\Consulta $consulta
     */
    public function removeConsulta(\AppBundle\Entity\Consulta $consulta)
    {
     ...
     * @return Paciente
     */
    public function addIngreso(\AppBundle\Entity\Ingreso $ingreso)
    {
     ...
     * @param \AppBundle\Entity\Ingreso $ingreso
     */
    public function removeIngreso(\AppBundle\Entity\Ingreso $ingreso)
    {
