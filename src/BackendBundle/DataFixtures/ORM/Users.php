...
use BackendBundle\Entity\DoctorUser;
use BackendBundle\Entity\EstudianteUser;
use BackendBundle\Entity\ResidenteUser;
use BackendBundle\Entity\LaboratorioUser;
use BackendBundle\Entity\EnfermeroUser;
